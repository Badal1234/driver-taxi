    ...
    componentDidMount(){
        if(this.getRideDetails){
            ...
            this.setState({
                ...
                intialregion:{
                    latitude: this.getRideDetails.pickup.latitude,
                    longitude: this.getRideDetails.pickup.longitude,
                ...
                this.getDirections('"'+this.state.paramData.pickup.latitude+','+this.state.paramData.pickup.longitude+'"', '"'+this.state.paramData.drop.latitude+','+this.state.paramData.drop.longitude+'"');
                this.forceUpdate();
            })
        }
    }
                ...
                <ScrollView>
                    <View style={styles.mapView}>
                        <View style={styles.mapcontainer}>
                            ...
                            >
                                <Marker
                                    coordinate={{latitude:this.state.paramData?(this.state.paramData.pickup.latitude):0.00, longitude: this.state.paramData?(this.state.paramData.pickup.longitude):0.00}}
                                    title={'pick-up location'}
                                    description={this.state.paramData?this.state.paramData.pickup.place:null}
                                />

                                <Marker
                                    coordinate={{latitude: this.state.paramData?(this.state.paramData.drop.latitude):0.00, longitude: this.state.paramData?(this.state.paramData.drop.longitude):0.00}}
                                    title={'drop location'}
                                    description={this.state.paramData?this.state.paramData.drop.place:null}
                    ...
                    <View style={styles.rideDesc}>
                        ...
                        <View style={styles.userDesc}>
                            ...
                            />
                            <View style={styles.userView}>
                                <Text style={styles.textStyle}>{Currency} {this.state.paramData && this.state.paramData.trip_cost>0?parseFloat(this.state.paramData.trip_cost).toFixed(2):this.state.paramData && this.state.paramData.estimate?this.state.paramData.estimate:0 }</Text>
                            </View>
                        </View>
                    </View> 
                    <View style={styles.locationView}>
                        <View style={styles.location}>
                            ...
                            <View style={styles.address}>
                                ...
                                <Text style={styles.adressStyle}>{ this.state.paramData ? this.state.paramData.pickup.place : ""}</Text>
                            </View>
                        </View>
                        <View style={styles.location}>
                            <View>
                            ...
                            <View style={styles.address}>
                                ...
                                <Text style={styles.adressStyle}>{ this.state.paramData ? this.state.paramData.drop.place : ""}</Text>
                            </View>
                        </View>
                    </View>  
                    ...
                    <View style={styles.billView}>
                        ...
                        <View style={styles.billOptions}>
                            <View style={styles.billItem}>
                                ...
                                <Text style={styles.billAmount}>{this.state.paramData ? Currency + parseFloat(this.state.paramData.trip_cost).toFixed(2) : "0"}</Text>
                            </View>
                            <View style={styles.billItem}>
                                <View>
                                ...
                                <Text style={styles.billAmount}>{this.state.paramData && this.state.paramData.convenience_fees? '-'+ Currency + parseFloat(this.state.paramData.convenience_fees).toFixed(2) : "0"}</Text>
                            </View>
                        </View>
                        <View style={styles.paybleAmtView}>
                            <Text style={[styles.billTitle,{color:'green'}]}>{languageJSON.total_payable}</Text>
                            <Text style={[styles.billTitle,{color:'green'}]}>{this.state.paramData && this.state.paramData.driver_share? Currency + parseFloat(this.state.paramData.driver_share).toFixed(2) : "0"}</Text>
                        </View>
                    </View>
                    :null:null}
