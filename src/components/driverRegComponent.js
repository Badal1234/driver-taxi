...
export default class DiverReg extends React.Component {
    ...
    onPressRegister(){
       ...
       if ( fnameValid && lnameValid && mobileValid && emailValid && passwordValid && cnfPwdValid && vehicleNumValid && vehicleNameValid && imageValid ) {
            ...
            onPressRegister( this.state.fname, this.state.lname, this.state.mobile, this.state.email, this.state.password, this.state.vehicleNum, this.state.vehicleName, this.state.image, this.state.image1);
                        ...
                        <View style={styles.containerStyle}>
                            ...
                            <View style={styles.textInputContainerStyle}>
                                ...
                                <Input
                                    ...
                                    errorMessage={this.state.cnfPwdValid ? null : languageJSON.password_not_match}
                                    secureTextEntry
                                    blurOnSubmit={true}
                                    onSubmitEditing={() => { this.validateConfPassword(); this.vehicleNameInput.focus() }}
                                    errorStyle={styles.errorMessageStyle}
                                    inputContainerStyle={styles.inputContainerStyle}
                                    containerStyle={styles.textInputStyle}
                                />
...

                            {
                                ...
                                image1?
                                <View style={styles.imagePosition}>
                                    <TouchableOpacity style={styles.photoClick} onPress={this.cancelCarPhoto}>
                                        <Image source={require('../../assets/images/cross.png')} resizeMode={'contain'} style={styles.imageStyle} />
                                    </TouchableOpacity>
                                    <Image source={{ uri: image1 }} style={styles.photoResult} resizeMode={'cover'}/>
                                </View>
                                :
                                <View style={styles.capturePhoto}>   
                                    <View>
                                        {
                                            this.state.imageValid ?
                                            <Text style={styles.capturePhotoTitle}>{languageJSON.car_image}</Text>
                                            :
                                            <Text style={styles.errorPhotoTitle}>{languageJSON.car_image}</Text>
                                        }
                                        
                                    </View>
                                    <View style={styles.capturePicClick}>
                                        <TouchableOpacity style={styles.flexView1} onPress={this.CaptureCarImage}> 
                                            <View>  
                                                <View style={styles.imageFixStyle}>
                                                    <Image source={require('../../assets/images/camera.png')} resizeMode={'contain'} style={styles.imageStyle2} />
                                                </View>
