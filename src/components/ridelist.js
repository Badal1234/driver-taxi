                ...
                <View style={styles.flexViewStyle}>
                    <View style={styles.textView1}>
                        ...
                        <View style={[styles.picupStyle, styles.position]}>
                            ...
                            <Text style={[styles.picPlaceStyle, styles.placeStyle]}>{item.pickup.place ? item.pickup.place : ""}</Text>
                        </View>
                        <View style={[styles.dropStyle, styles.textViewStyle]}>
                            <View style={[styles.redDot, styles.textPosition]} />
                            <Text style={[styles.dropPlaceStyle, styles.placeStyle]}>{item.drop.place ? item.drop.place : ""}</Text>
                        </View>
